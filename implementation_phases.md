...
- MySQL 8.0.13+ (or Percona 8.0.13+) environment with partial unique indexes confirmed available. (`EXPLAIN ANALYZE` is an 8.0.18+ operator-runbook tool per ADR `0019`/`0023`; the engine does not depend on it and Phase 0 does not smoke-test for it.)
