...
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `adrs/` — Architecture Decision Records | Immutable log of _why_ key technical decisions were made (e.g., "Why extension tables over EAV?"). Prevents re-litigating settled debates.               |
