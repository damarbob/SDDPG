# Vertical Partitioning Migration Plan (Implementation-Ready)
...
## 6. Legacy Data Migration: Asynchronous Atomicity

Existing tenants must be migrated without locking or threatening the availability of the legacy Virtual Column system.

### 6.1 Asynchronous Dual-Write (Event Stream)
...
### 6.2 Dead Letter Queue (DLQ) Lifecycle & Observability
...
### 6.3 Idempotent & Resumable Backfill Pump
...
### 6.4 Validation & Cutover (Three-Gate Protocol)
...
3.  **Shadow Traffic** *(optional)*: Route 5% of reads to the new schema; verify P99 latency and 0 correctness mismatches.

### 6.5 Safe Rollback Protocol
